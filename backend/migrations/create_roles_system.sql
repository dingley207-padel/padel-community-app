...
CREATE TABLE IF NOT EXISTS notifications_history (
  ...
  body TEXT NOT NULL,
  recipient_type VARCHAR(50) NOT NULL, -- 'all_community', 'session_attendees', 'individual'
  recipient_ids UUID[], -- Array of user IDs who received the notification
...
-- Create session_attendance table (for Phase 2)
